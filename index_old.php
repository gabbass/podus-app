...
<head>
    <meta charset="UTF-8">
	<meta name="description" content="O Universo do Saber oferece ferramentas digitais, planejamentos BNCC, gerador de provas, jogos pedagógicos e suporte completo para professores, gestores e escolas de todo o Brasil. Transforme sua rotina educacional com tecnologia, inovação e praticidade." />
...
<header class="header">
        <div class="container">
            <div class="logo">
                <a href="index">
                     <img src="img/logo-hor.webp" alt="Logo do Portal">
                </a>
            </div>
...
<section class="institutional-section" id='institucional'>
    <div class="container">
        ...
        <div class="institutional-image">
                <img src="img/institucional.webp" alt="Equipe do Portal Universo do Saber">
...
<section class="support-section" id='contato'>
    <div class="container">
        <h2 class="section-title">Quer conhecer mais do nosso trabalho? Precisa de ajuda?</h2>
        <center><p class="section-subtitle">Preencha o formulário abaixo e nós iremos entrar em contato com você!</p></center>
        ...
        <form class="support-form" method="POST" action="processar-contato.php">
			...
			<div class="form-row">
			<div class="form-group aceite-termos">
			 <input type="checkbox" id="aceite-termos" name="aceite_termos" required>
				<label for="aceite-termos">
					Li e aceito os <b><a href="/termos-uso.html" target="_blank">Termos de Uso</a></b> e a <b><a href="/politica-privacidade.html" target="_blank">Política de Privacidade</a></b>.
				</label>
			</div>
			<div class="form-group aceite-whatsapp">
				 <input type="checkbox" id="aceite-whatsapp" name="aceite_whatsapp" required>
				<label for="aceite-whatsapp">
					Autorizo receber contato via WhatsApp no número informado acima.
				</label>
			</div>
    ...
    <div class="cookie-banner-texto">
        Este site utiliza cookies para melhorar sua experiência, analisar o tráfego e personalizar conteúdos. 
        Ao continuar navegando, você concorda com nossa <a href="/politica-privacidade.html" target="_blank">Política de Privacidade</a>.
    </div>
    <button id="btnAceitarCookies" class="btn-cookie">Aceitar</button>
	</div>
