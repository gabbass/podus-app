...
$tituloPagina = "Planejamento Mensal - Universo do Saber"; include dirname(__DIR__) . '/includes/head.php';
?>
		...
		<div class="content-container" id="content-container">
			...
			<div class="container">
				...
				<div class="segundo-container oculto destaque" id="crudPlanejamentoMensalContainer">
					<?php include dirname(__DIR__) . '/includes/crud-planejamento-mensal.php'; ?>
				</div>
        
				<!-- Filtros -->
				<div class="filtros-container">
					<?php include dirname(__DIR__) . '/includes/filtro-planejamento-mensal.php'; ?>
				</div>
			
				<!-- Tabela de planejamentos -->
				<div class="table-container">
				   <?php include dirname(__DIR__) . '/includes/lista-planejamento-mensal.php'; ?>
				</div>
			</div>
		</div>
	</div> 
