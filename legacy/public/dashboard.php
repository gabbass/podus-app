...
<head>
    ...
    <title>Gerador de Avaliações - Universo do Saber</title>
        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h1>Dashboard</h1> 
                    <p>Bem-vindo ao Gerador de Avaliações</p>
                </div>
                <button class="btn btn-primary" onclick="location.assign('cadastrar-questao')"><i class="fas fa-plus-circle"></i> Nova Questão</button>
            </div>
            <!-- Cards -->
            <div class="card-container">
                <div class="card">
                    <div class="card-header" onclick="location.assign('pesquisar-professores')">
                ...
                <div class="card">
                    <div class="card-header" onclick="location.assign('pesquisar-questoes')">
                ...
                <div class="card">
                    <div class="card-header" onclick="location.assign('pesquisar-artigos')">
