    ...
    <div class="main-content">
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="form-group">
                    <label>Projetos Integrador</label>
                    <div class="view-textarea"><?= nl2br(htmlspecialchars($campos['projetos_integrador'])) ?></div>
                </div>
                ...
                <div class="form-group">
                    <label>DIAGNÓSTICO/PERFIL DE TURMA(S)</label>
                    <div class="view-textarea"><?= nl2br(htmlspecialchars($campos['diagnostico'])) ?></div>
                </div>
                
                <div class="form-group">
                    <label>REFERÊNCIAS</label>
                    <div class="view-textarea"><?= nl2br(htmlspecialchars($campos['referencias'])) ?></div>
                </div>
