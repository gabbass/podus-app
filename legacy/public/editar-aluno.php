...
// Verifica se foi passado um ID de aluno para edição
$aluno = null;
if (isset($_GET['id'])) {
    $aluno_id = $_GET['id'];
    ...
    $erro = "Nenhum aluno selecionado para edição!";
    header('Location: pesquisar-alunos');
    exit;
}
...
<head>
    ...
    <title>Editar Aluno - Universo do Saber</title>
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="matricula" name="matricula" class="form-control" 
                                   value="<?= htmlspecialchars($aluno['matricula']) ?>" required>
                        </div>
