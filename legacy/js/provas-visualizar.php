<?php
require dirname(__DIR__) . '/public/sessao-adm-professor.php';
require dirname(__DIR__) . '/public/conexao.php';     
...
<body>
  ...
  <div class="main-content" id="main-content">
        ...
        <div class="page-header">
		  ...
		  <div class="btn-group">
		   <button type="button" class="btn btn-primary" id="btnNovaProva">
              <i class="fas fa-pdf"></i> Gerar impressão
            </button>
			</div>
		</div>
			<div id="cabecalho">
    ...
    <script src="js/visua-provas.js"></script>
</body>
