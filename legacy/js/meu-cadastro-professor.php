<?php
require dirname(__DIR__) . '/public/sessao-professor.php';
require(dirname(__DIR__) . '/includes/cad-professor.php');
$tituloPagina = "Meu cadastro - Universo do Saber"; include dirname(__DIR__) . '/includes/head.php';
?>
