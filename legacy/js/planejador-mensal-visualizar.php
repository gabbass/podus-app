...
require_once dirname(__DIR__) . '/public/sessao-professor.php';
require_once dirname(__DIR__) . '/public/conexao.php'; // conexão com portal_do_universo
require_once dirname(__DIR__) . '/public/conexao-bncc.php'; // conexão com banco BNCC
