...
// Verifica se foi passado um ID de turma para edição
$turma = null;
if (isset($_GET['id'])) {
    $turma_id = $_GET['id'];
    ...
    try {
        ...
        if (!$turma) {
            $erro = "Turma não encontrada ou você não tem permissão para editá-la!";
    ...
    $erro = "Nenhuma turma selecionada para edição!";
    header('Location: cadastrar-turmas.php');
    exit;
}
    ...
    if (empty($nome)) {
        ...
        try {
            ...
            $sql = "UPDATE turmas SET 
                    nome = :nome 
                    WHERE id = :id AND login = :login_professor";
            
            $stmt = $conexao->prepare($sql);
            $stmt->bindParam(':nome', $nome);
            $stmt->bindParam(':id', $turma_id);
            $stmt->bindParam(':login_professor', $login_professor);
...
<head>
    ...
    <title>Editar Turma - Universo do Saber</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        /* Estilos mantidos iguais ao arquivo original */
        :root {
            --primary-blue: #0057b7;
        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h1>Editar Turma</h1>
                    <p>Atualize os dados da turma abaixo</p>
                </div>
