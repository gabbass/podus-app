    ...
    class LegacyConfig
    {
        ...
        private const DEFAULT_MAIL_CONFIGS = [
            'default' => [
                ...
                'port' => 1025,
                'encryption' => '',
                'username' => 'podus-default@example.com',
                'password' => 'secret',
                'from_address' => 'podus-default@example.com',
                'from_name' => 'Podus',
                'debug' => 0,
            ],
            'invite' => [
                ...
                'port' => 1025,
                'encryption' => '',
                'username' => 'podus-invite@example.com',
                'password' => 'secret',
                'from_address' => 'podus-invite@example.com',
                'from_name' => 'Podus Convites',
                'debug' => 0,
            ],
            'recovery' => [
                'host' => 'mailhog',
                'port' => 1025,
                'encryption' => '',
                'username' => 'podus-recovery@example.com',
                'password' => 'secret',
                'from_address' => 'podus-recovery@example.com',
                'from_name' => 'Podus - Recuperação de Senha',
                'debug' => 0,
            ],
            'contact' => [
                'host' => 'mailhog',
                'port' => 1025,
                'encryption' => '',
                'username' => 'podus-contact@example.com',
                'password' => 'secret',
                'from_address' => 'podus-contact@example.com',
                'from_name' => 'Podus - Contato',
                'to_address' => 'suporte@example.com',
                'cc_address' => '',
                'debug' => 0,
            ],
        ];
        ...
        private const DEFAULT_RECAPTCHA = [
            ...
            'site_keys' => [
                'CHECKBOX' => 'testing-site-checkbox',
                'V3' => 'testing-site-v3',
            ],
        ];
